---
name: user-flow
description: "Maps multi-step in-product flows — screens, decisions, transitions, edge cases, and error states for features or user journeys. Produces `.agents/user-flow.md`. Not for visual brand design (use brand-system) or single-page conversion (use lp-optimization)."
